# # ============================================================================
# # INTEGRATION TESTS - All scenarios for each central bank
# # ============================================================================
...
#         assert len(result) == 1
#         assert len(result[0]["meeting_dates"]) == 2
#         # Should have probabilities for positive steps
#         positive_steps = [
#             pm for pm in result[0]["probability_matrix"] if pm["expected_rate_step"] > 0
#         ]
...
#         assert len(result) == 1
#         assert len(result[0]["meeting_dates"]) == 2
#         # Should have probabilities for negative steps
#         negative_steps = [
#             pm for pm in result[0]["probability_matrix"] if pm["expected_rate_step"] < 0
#         ]
