...
const dropdownValues = JSON.parse('{{ dropdown_values|escapejs }}');
const marketData = JSON.parse('{{ market_data|escapejs }}');
const selectedValues = JSON.parse('{{ selected_values|escapejs }}')[0];
...
createYieldSpreadChart('yieldSpreadChart', marketData.spread_rates, selectedValues.main_rate, selectedValues.spread_rate, 'spreadHeader');